...
pub fn public_game_players_to_markup_players(game_players: &[PublicGamePlayerTypeUser])
...
pub fn game_players_to_markup_players(game_players: &[GamePlayerTypeUser])
                                      -> Result<Vec<markup::Player>> {
